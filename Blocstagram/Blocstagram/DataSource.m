...
- (void) parseDataFromFeedDictionary:(NSDictionary *) feedDictionary fromRequestWithParameters:(NSDictionary *)parameters {
    ...
    if (parameters[@"min_id"]) {
        ...
        [self didChangeValueForKey:@"mediaItems"];
        // These inform the KVO system that 'self.mediaItems' is about to be replaced, and has been replaced, by a different array. This triggers a notification to the table view to reload all of its data.
    }
                                 ...
                                 parameters:nil
                                    success:^(AFHTTPRequestOperation *operation, id responseObject) {
                                        if ([responseObject isKindOfClass:[UIImage class]]) {
                                            ...
                                            NSMutableArray *mutabeArrayWithKVO = [self mutableArrayValueForKey:@"mediaItems"];
                                            NSUInteger index = [mutabeArrayWithKVO indexOfObject:mediaItem];
                                            [mutabeArrayWithKVO replaceObjectAtIndex:index withObject:mediaItem];
                                            [self saveImages];
                                        }else {
